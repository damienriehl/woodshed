...
export type CommunityArchiveEnvelope={envelopeVersion:1;profile:typeof COMMUNITY_ARCHIVE_PROFILE;archiveId:string;sourceCommunityId:string;destinationCommunityId:string;createdAt:string;expiresAt:string;recipientKeyId:string;ephemeralPublicKey:string;wrapIv:string;wrappedKey:string;wrapTag:string;payloadIv:string;ciphertext:string;payloadTag:string};
