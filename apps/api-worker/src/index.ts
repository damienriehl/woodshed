...
const errorStatus:Record<string,number>={unauthorized:401,denied:403,"not-found":404,conflict:409,"stale-revision":409,"superseded-authority":409,"authority-already-held":409,"replay-mismatch":409};
...
export default {async fetch(request:Request,env:WorkerBindings):Promise<Response>{
  try{
    ...
    const authorityRoutes:[string,string,string,number][]=[["/live/authority/acquire","/authority/acquire","POST",200],["/live/authority/handoffs","/authority/handoffs","POST",201],["/live/authority/handoffs/confirm","/authority/handoffs/confirm","POST",200]];
