...
> Status: experimental adapter slice, not a complete Woodshed deployment. It currently proves D1-backed discovery, authenticated ballot replacement, live queue commands, and Durable Object authority handoff/recovery. It does not yet issue participant sessions or expose proposals, draft setlists, staffing, or rehearsal APIs. Use the Node/SQLite runtime for the complete implemented application surface.
