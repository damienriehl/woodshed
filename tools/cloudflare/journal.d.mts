export interface StagingIdentity { accountId: string; databaseId: string; workerName: string; origin: string }
export interface StagingJournal { version: 1; runId: string; owner: string; sourceSha: string; phase: string; identity: StagingIdentity; resources: unknown[]; mutations: unknown[]; migrations: Array<{ filename: string; sha256: string; sourceSha: string; status: string }>; createdAt: string; updatedAt: string }
